 /**
  ...
  const PLAYER_STORAGE_KEY = 'Music_PLAY_Linh'
  ...
  const app = {
      ...
      handleEvents: function() {
          ...
          //Xu ly khi tua song sử dụng sự kiện oninput thay vì onchange 
          // bởi onchange chỉ đc kích hoạt khi người dùng thả chuột. Để nhận được bản liên tục
          // oninput sẽ bắt cả từ chuột và bàn phím 
      ...
      start: function() {
          //Gán cấu hình từ config vào cấu hình gốc
          this.loadConfig()
